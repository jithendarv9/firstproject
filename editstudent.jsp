...
<body>
	...
	<form1:form method="POST" modelAttribute="student"  class="form-horizontal" action="/springexample/editsave">
...
<div class="row">
		...
		<div class="row">
			<div class="form-group col-md-12">
				...
				<div class="col-md-7">
					<form1:input type="text" path="lastName" id="lastName" class="form-control input-sm"/>
					<div class="has-error">
		...
		<div class="row">
			<div class="form-group col-md-12">
				...
				<div class="col-md-7" class="form-control input-sm">
					<form1:radiobutton path="sex" value="M" />Male 
	    			<form1:radiobutton path="sex" value="F" />Female
					<div class="has-error">
						<form1:errors path="sex" class="help-inline"/>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="form-group col-md-12">
				...
				<div class="col-md-7">
					<form1:select path="country" id="country" class="form-control input-sm">
				        <form1:option value="">Select Country</form:option>
			    	    <form1:options items="${countries}" />
				    </form1:select>
					<div class="has-error">
